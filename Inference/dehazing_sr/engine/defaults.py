...
from dehazing_sr.config import CfgNode
from dehazing_sr.utils.file_io import PathManager
...
""",
    ...
    parser.add_argument("--config-files", nargs="+", default=[""], metavar="FILE", help="path to config file")
